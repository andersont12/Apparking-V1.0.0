...
class ModeloUsuarios{
		...
		if($item != null)
			{
				...
				{
					$condicion="select * from ".$tabla." where ".$item." = '".$valor."' AND ".$item2." = '".$encriptar."'";
					$stmt = Conexion::conectar()->prepare($condicion);
					$stmt -> execute();
					return $stmt->fetch();
				}
	...
	static public function mdlIngresarUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, usuario, clave, perfil, foto) VALUES (:nombre, :usuario, :clave, :perfil, :foto)");
